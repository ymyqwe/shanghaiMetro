...
},{"./bundle-url":"../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"sass/style.scss":[function(require,module,exports) {
...
var simulation = d3.forceSimulation(nodes).force('y', d3.forceY()).force('brown', isolate(d3.forceX(-width / 6), function (d) {
  return d.color === 'brown';
})).force('steelblue', isolate(d3.forceX(width / 6), function (d) {
  return d.color === 'steelblue';
})).force('charge', d3.forceManyBody().strength(-10)).on('tick', ticked);
...
},{"d3":"node_modules/d3/index.js","./sass/style.scss":"sass/style.scss"}],"../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/shanghaiMetro.e31bb0bc.map